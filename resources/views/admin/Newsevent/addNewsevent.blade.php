                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-7">
                                ...
                                <textarea name="event_title" id="event_title" class="form-control" placeholder="enter event title.."></textarea>
                                @error('event_title')
                                ...
                                <textarea name="event_detail" id="event_detail" class="form-control" placeholder="enter the event details..." cols="30" rows="10"></textarea>
                                @error('event_detail')
                                    <span class="text-danger">{{ $message }}</span> <br>
                                @enderror

                                <label for="event_video" class="mt-2">Enter Event YouTube Video Link </label>
                                <input type="text" name="event_video" id="event_video" class="form-control" placeholder="toutube video link ....">
                            </div>
                            <div class="col-lg-5 my-auto" style="border:1px solid rgba(227, 223, 223, 0.447);" class="bg-info">
                                <label for="event_img">
                                    <img class="eventtImagePicture" style="max-width: 100%; padding:20px; cursor: pointer;" src="{{ asset('custom_img/img_placeholder_2.jpg') }}" alt="">
                                </label>
